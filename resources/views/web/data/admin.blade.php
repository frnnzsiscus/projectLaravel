...
@section('header')
    <style>
        ...
        /* Tambahkan warna biru pada navigasi admin */
        .nav-admin {
...
@section('main')
    <section class="pt-2 container pb-5">
        <div class="card text-center border-2" style="background-color: #87CEEB;"> <!-- Warna biru muda -->
            <div class="card-body">
        ...
        <div class="container-fluid px-4 pt-4 pb-5">
            <div class="row gap-4 justify-content-sm-around">
                {{-- Card 1 --}}
                <div class="card shadow-lg text-bg-primary mb-3" style="max-width: 18rem; background-color: #87CEEB;">
                ...
                {{-- Card 2 --}}
                <div class="card shadow-lg text-bg-success mb-3" style="max-width: 18rem; background-color: #87CEEB;">
                ...
                {{-- Card 3 --}}
                <div class="card shadow-lg text-bg-warning mb-3" style="max-width: 18rem; background-color: #87CEEB;">
