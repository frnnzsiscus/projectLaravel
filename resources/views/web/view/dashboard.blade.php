...
@section('footer')
    <div class="container-flex text-center p-4" style="background: #87CEEB">
        <div class="card text-center" style="background: #87CEEB">
            <div class="card-header" style="background: #4169E1">
            </div>
            <div class="card-body">
                <h5 class="card-title">Thrift Shop</h5>
                <p class="card-text">Punya Duit Punya Kuasa Disini</p>
                <a href="#" class="btn btn-primary">Pakaian Thrift Berkualitas</a>
            </div>
            <div class="card-footer text-body-secondary" style="background: #87CEEB">
