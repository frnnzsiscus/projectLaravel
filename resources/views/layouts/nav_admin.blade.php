<nav class="navbar shadow-xl" style="background-color: #4169E1;">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" style="color: white;"
            ...
            <div class="offcanvas-header" style="background-color: #4169E1; color: white;">
                <h3 class="offcanvas-title" id="offcanvasScrollingLabel">
                    Admin Dashboard
                </h3>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body" style="background-color: #87CEEB;">
